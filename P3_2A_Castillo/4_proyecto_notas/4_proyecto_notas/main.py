import funciones
import usuarios import usuario
...
def main():
    ...
    while opcion:
        ...
        if opcion=="1" or opcion=="REGISTRO":
            ...
            if registro:
                print(f"{nombre} {apellidos} se registró correctamente, ocon el email: {email}")
            else:
                print(f"\n\t No fue porsible registrar el usuario, inténtelo más tarde. ")
            ...
            if lista_usuario:
                ...
                print(f"E-mail y/o contraseña incorrectos, por favor verifica e inténtalo de nuevo.")
                funciones.esperarTecla()
